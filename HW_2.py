...
data = {
    'Ученики' : ['Синицына', 'Чернов', 'Сидорчук', 'Ефимова', 'Кузнецов', 'Иванов', 'Петров', 'Смирнов', 'Козлов',
                 'Попов'],
    'Математика': [5, 4, 5, 3, 5, 3, 5, 5, 4, 1],
...
print((f"Q3 - {Q3}"))
print((f"IQR - {IQR}"))
print((f"Стандартное отклонение математики - {df['Математика'].std()}"))
...
#
# print(df['Математика'].cat.categories)
# print(df['Русский язык'].cat.categories)
# print(df['Физика'].cat.categories)
# print(df['Информатика'].cat.categories)
